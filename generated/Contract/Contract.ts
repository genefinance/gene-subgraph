...
export class Contract extends ethereum.SmartContract {
  ...
  bonusStartBlock(): BigInt {
    let result = super.call(
      "bonusStartBlock",
      "bonusStartBlock():(uint256)",
      []
    );
  ...
  try_bonusStartBlock(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "bonusStartBlock",
      "bonusStartBlock():(uint256)",
      []
  ...
  getBonus(_from: BigInt, _to: BigInt): BigInt {
    let result = super.call("getBonus", "getBonus(uint256,uint256):(uint256)", [
  ...
  try_getBonus(_from: BigInt, _to: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getBonus",
      "getBonus(uint256,uint256):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(_from),
        ethereum.Value.fromUnsignedBigInt(_to)
      ]
  ...
  getMultiplier(_from: BigInt, _to: BigInt, _rewardEndBlock: BigInt): BigInt {
    let result = super.call(
      "getMultiplier",
      "getMultiplier(uint256,uint256,uint256):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(_from),
        ethereum.Value.fromUnsignedBigInt(_to),
        ethereum.Value.fromUnsignedBigInt(_rewardEndBlock)
      ]
    );
  ...
  mvs(): Address {
    let result = super.call("mvs", "mvs():(address)", []);

    return result[0].toAddress();
  }

  try_mvs(): ethereum.CallResult<Address> {
    let result = super.tryCall("mvs", "mvs():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  mvsPerBlock(): BigInt {
    let result = super.call("mvsPerBlock", "mvsPerBlock():(uint256)", []);

    return result[0].toBigInt();
  }

  try_mvsPerBlock(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("mvsPerBlock", "mvsPerBlock():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  pendingMvs(_pid: BigInt, _user: Address): BigInt {
    let result = super.call(
      "pendingMvs",
      "pendingMvs(uint256,address):(uint256)",
      [
  ...
  try_pendingMvs(_pid: BigInt, _user: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "pendingMvs",
      "pendingMvs(uint256,address):(uint256)",
      [
  ...
  poolInfo(param0: BigInt): Contract__poolInfoResult {
    let result = super.call(
      "poolInfo",
      "poolInfo(uint256):(address,uint256,uint256,uint256,uint256,uint256)",
...
export class AddCall__Inputs {
  ...
  get _lockEndBlock(): BigInt {
    return this._call.inputValues[1].value.toBigInt();
  }

  get _rewardEndBlock(): BigInt {
    return this._call.inputValues[2].value.toBigInt();
  }
