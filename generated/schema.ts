...
export class GeneFinanceFactory extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save GeneFinanceFactory entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save GeneFinanceFactory entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("GeneFinanceFactory", id.toString(), this);
  }

  static load(id: string): GeneFinanceFactory | null {
    return store.get("GeneFinanceFactory", id) as GeneFinanceFactory | null;
  }
...
export class GeneFinanceDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save GeneFinanceDayData entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save GeneFinanceDayData entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("GeneFinanceDayData", id.toString(), this);
  }

  static load(id: string): GeneFinanceDayData | null {
    return store.get("GeneFinanceDayData", id) as GeneFinanceDayData | null;
  }
